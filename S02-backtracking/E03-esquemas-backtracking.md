<h1 align="center">E03 - Esquemas en Backtracking</h1>

> [!TLDR]
> Backtracking resuelve tres tipos de problemas: **Decisión** (¿existe al menos una solución?), **Optimización** (¿cuál es la mejor?) y **Enumeración** (¿cuáles son todas?).
