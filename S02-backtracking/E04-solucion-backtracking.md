<h1 align="center">E04 - Cómo Saber si Existe una Solución</h1>

> [!TLDR]
> La función retorna `true` al encontrar la primera solución válida, propagando el éxito hacia arriba y deteniendo la búsqueda. Si agota todas las ramas sin éxito, retorna `false`.
