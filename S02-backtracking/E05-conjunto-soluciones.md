<h1 align="center">E05 - Cómo Encontrar Todas las Soluciones y la Mejor</h1>

> [!TLDR]
> Para **todas las soluciones**, se guarda cada resultado en una lista y se continúa buscando. Para **la mejor**, se mantiene una variable con el óptimo actual y se actualiza al encontrar uno superior. En ambos casos se explora el árbol completo.
