...
// Estructura de Montículo Máximo (Max-Heap).
...
// 0 del arreglo).
// Ventajas: inserción O(log N) y extracción del máximo O(log N) constantes y eficientes.
// T representa el tipo de dato de las claves del montículo.
template <typename T> class DrxHeap {
  public:
	// Constructor: Reserva memoria para la capacidad inicial especificada.
	...
	// Remueve y retorna el elemento máximo (la raíz/tope) del montículo.
	...
	// Mezcla otro montículo sin añadir claves duplicadas.
	...
	// Sobrecarga del operador de salida en flujo para imprimir.
  ...
  private:
	...
	// Redimensiona dinámicamente el arreglo a un nuevo tamaño físico.
	...
	// Dado que el árbol es completo, podemos calcular los índices de padres e hijos directamente:
	...
	// Verifica si un nodo cumple la propiedad local de montículo máximo con sus hijos.
	...
	// Hunde un valor en la jerarquía (Heapify-Down).
	...
	// Hace flotar un valor en la jerarquía (Heapify-Up).
