<h1 align="center">E01 - El Concepto de la Recursividad</h1>

> [!TLDR]
> La **recursividad** es cuando una función se llama a sí misma para resolver versiones más pequeñas del mismo problema. Requiere un **caso base** que detenga la cadena y un **paso recursivo** que reduzca el problema.
