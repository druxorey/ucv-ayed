<h1 align="center">E04 - Solución Iterativa</h1>

> [!TLDR]
> En la mayoría de los casos, la solución **iterativa** es mejor: usa memoria constante, es más rápida y más fácil de depurar. La recursividad solo se prefiere cuando simplifica drásticamente el código (ej. árboles).
